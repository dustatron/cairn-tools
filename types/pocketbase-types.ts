...
export type MonstersResponse<Texpand = unknown> = Required<MonstersRecord> & BaseSystemFields<Texpand>
export type PokerRoomResponse<Texpand = unknown> = Required<PokerRoomRecord> & BaseSystemFields<Texpand>
export type PokerUserResponse<Texpand = unknown> = Required<PokerUserRecord> & BaseSystemFields<Texpand>
export type PokerVoteResponse<Texpand = unknown> = Required<PokerVoteRecord> & BaseSystemFields<Texpand>
